        ...
        <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className="container flex h-14 max-w-screen-2xl items-center justify-between">
                ...
                <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
                    ...
                    <Link to="/leaderboard" className="transition-colors hover:text-foreground/80 text-foreground/60">Leaderboard</Link>
                    ...
                    <div className="fixed inset-0 top-14 z-50 grid h-[calc(100vh-3.5rem)] grid-flow-row auto-rows-max overflow-auto p-6 pb-32 shadow-md animate-in slide-in-from-bottom-80 md:hidden">
                        <div className="relative z-20 grid gap-6 rounded-md bg-popover p-4 text-popover-foreground shadow-md">
                            ...
                            <nav className="grid gap-2">
                                ...
                                <Link to="/leaderboard" className="flex w-full items-center py-2 text-sm font-medium hover:underline" onClick={() => setIsMenuOpen(false)}>
                                    Leaderboard
                                </Link>
